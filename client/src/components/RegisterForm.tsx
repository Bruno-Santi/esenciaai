    ...
    <section>
      <form className='flex flex-col space-y-2 pt-4 w-[250px]' onSubmit={handleSubmit(onSubmit)}>
        ...
        <input
          ...
          type='text'
          placeholder='Name'
          {...register("name", { required: "This field is required", maxLength: 20 })}
        />
        {errors.name && <p className='  w-fit text-red-500 font-poppins m-auto'>{errors.name.message}</p>}
        <label className=' text-tertiary text-lg font-normal' htmlFor='lastName'>
          Last Name (*)
        </label>
        <input
          className='h-12 w-64 rounded-md p-2 text-sm font-thin  border-2 duration-500 text-primary focus:outline-none focus:border-2 focus:border-secondary/80 focus:font-bold'
          ...
          {...register("lastName", { required: "This field is required", maxLength: 29 })}
        />
        {errors.lastName && <p className='w-fit text-red-500 font-poppins m-auto'>{errors.lastName.message}</p>}
        ...
        />
        {errors.email && <p className=' w-fit text-red-500 font-poppins m-auto'>{errors.email.message}</p>}
        ...
        />
        {errors.password && <p className='w-fit text-red-500 font-poppins m-auto'>{errors.password.message}</p>}
