...
export const LandingPage = () => {
  ...
  return (
    <div
     ...
     w-full '
    >
      <div className='flex flex-col   items-center  justify-center pt-12 lg:p-20 space-y-6 lg:space-y-10 animate__animated animate__fadeIn animate__slower '>
        ...
        <Divider />
        <h1 className='font-manrope  font-bold text-tertiary w-5/6 lg:w-3/6 text-3xl lg:text-5xl text-center m-auto'>
          Dive into our vision of <span className='text-secondary leading-3'>revolutionizing</span> Agile Leadership.{" "}
        </h1>
        <p className='w-10/12 lg:w-4/12 text-center text-tertiary m-auto font-thin text-lg lg:text-xl'>
        ...
        <div
          ...
          className='btn-primary m-auto p-2 lg:p-4 rounded-md font-poppins w-32 text-center text-lg lg:text-2xl duration-500 hover:bg-tertiary hover:text-secondary'
        >
          Dive In
        </div>
      </div>
